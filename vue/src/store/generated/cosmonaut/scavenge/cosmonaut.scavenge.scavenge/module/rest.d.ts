...
export interface ScavengeQueryPostsResponse {
    title?: string;
    body?: string;
}
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     * @request GET:/cosmonaut/scavenge/scavenge/posts
     */
    queryPosts: (params?: RequestParams) => Promise<HttpResponse<ScavengeQueryPostsResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
